...
for run_name, run_path in run_path_a:
    ...
    if os.path.exists(rad_out_path):
        rad_dat = distill_rad_data.run_distillr(run_name, setpt_a, rad_out_path, wthr_fn, tdv_fref)
        results_by_shd.setdefault(rad_dat[0], [rad_dat_hdr + setpt_hdr_a]).extend(rad_dat[1])
