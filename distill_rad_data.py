...
def run_distillr(run_name, climate_zone, view_config, clrstry_config, analysis_path):
    ...
    ill_dat = [['CZ', 'View', 'Clrstry', 'Az', 'WWR', 'Ann Hr', 'Month', 'Day', 'Hr', 'Day Type', 'Bad DGP', 'Good DGP', 'Bad Shaded?', 'Good Shaded?', '1ry DS', '2ry DS']]
